...
# adding two numbers
@bot.command()
async def addition(ctx, left: int, right: int):
...
@bot.command()
async def add(ctx, *, my_string: str):
...
bot.run("MTM0ODYzODUyNzI4OTU1NzA2NA.GYQ7Rq.rxEPK7zYupNTJ4FPEqhU62yHPMX3QBCt18u7Zc")
